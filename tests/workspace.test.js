...
import { validateFiles, validatePath, renameFiles, manifestPaths, shouldImport } from '../src/ide/workspace.js';
const starterFiles = { 'Cargo.toml': '', 'contracts/counter/Cargo.toml': '', 'contracts/counter/src/lib.rs': '' };
